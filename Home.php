...
<html>
          ...
          <div class="top ui secondary menu">
            <!--<a class="inverted item">Submit</a>-->
              <div class="left menu">
                ...
                <a class="item"><div class="ui search">
  ...
  <div class="results"></div>
            ...
            <div class="right menu">
              ...
              <a class="item sidebar"><i class="large user outline blue icon"></i></a>
            </div>
            </div>
            ...
            <div class="ui ten wide column">
                <div class="gg">
                    ...
                    foreach ($questionsData as $row)
                    {
                        ...
                        echo '<span class="right floated time">'.$row['DATE'].'</span>
